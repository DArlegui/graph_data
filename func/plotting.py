...
def plot_randomwalk(rw: RandomWalk, ax=None):
    fig, ax = get_fig_ax(ax)
...
def plot_molecular(rw: RandomWalk, ax=None):
    ...
    ax.scatter(0, 0, c="#00e676", edgecolors="none", s=5)
    ax.scatter(rw.x_values[-1], rw.y_values[-1], c="#ef5350", edgecolors="none", s=5)
